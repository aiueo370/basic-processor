...
//命令読解器
module control (clk, rst, opcd, sel_1, sel_2, sel_3, sel_4, sel_5, alucnt, aluimm, Mwe, we, br, rst_flag, ld);
	...
	output Mwe;			//データメモリ書き込み許可フラグ
	output we;				//レジスタ書き込み許可フラグ
	output rst_flag;		//リセットフラグ
	output ld;				//LD命令フラグ
	reg [1:0] alucnt,br;
	reg sel_1,sel_2,sel_3,sel_4,sel_5,aluimm,Mwe,we,rst_flag,ld;
	...
	case(opcd)
		4'b0001:	//ADD
			begin
				...
				alucnt <= 2'b00; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b1; br <= 2'b00;
		...
		4'b0010:	//SUB
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b1; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b01; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b1; br <= 2'b00;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b0011:	//AND
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b1; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b10; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b1; br <= 2'b00;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b0100:	//OR
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b1; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b11; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b1; br <= 2'b00;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b0111:	//SUBI
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b0; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b00; aluimm <= 1'b1; Mwe <= 1'b0;  we <= 1'b1; br <= 2'b00;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b1011:	//ST
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b0; sel_4 <= 1'b0; sel_5 <= 1'b1; 
				alucnt <= 2'b00; aluimm <= 1'b0; Mwe <= 1'b1;  we <= 1'b0; br <= 2'b00;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b1100:	//BEQ
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b0; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b00; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b0; br <= 2'b01;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b1101:	//BGT
			begin
				#1  sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b0; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b00; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b0; br <= 2'b10;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
		...
		4'b1110:	//JUMP
			begin
				#1 sel_1 <= 1'b0; sel_2 <= 1'b0; sel_3 <= 1'b0; sel_4 <= 1'b0; sel_5 <= 1'b0; 
				alucnt <= 2'b00; aluimm <= 1'b0; Mwe <= 1'b0;  we <= 1'b0; br <= 2'b00;
				rst_flag <= #1 1'b0; ld <= 1'b0;
			end
